...
This system is focused on the Warehouse and Store unit creation and management. 
So, this is not related to the internal operations of each, but, rather, to the basic creation and 
anagement of those and some operations related to how they relate to each other.
